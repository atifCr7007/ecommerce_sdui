...
class MockShopService {
  ...
  static final List<Shop> _mockShops = [
    ...
    // Additional food shops for shops_tab.json compatibility
    Shop(
      id: 'gourmet-kitchen',
      name: 'Cheelizza - India Ka Pizza',
      description: 'Authentic Indian pizza with traditional flavors and modern twist',
      logo: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=200&h=200&fit=crop',
      bannerImage: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=800&h=400&fit=crop',
      rating: 4.2,
      reviewCount: 2800,
      ...
      isVerified: true,
      isActive: true,
      featuredProductIds: ['food_001', 'food_002', 'food_003'],
      contact: ShopContact(
        email: 'orders@cheelizza.com',
        phone: '+91 98765 43210',
        website: 'https://cheelizza.com',
        address: ShopAddress(
          street: 'Shop 15, Vashi Plaza',
          city: 'Vashi',
          state: 'Maharashtra',
          country: 'India',
          zipCode: '400703',
    ...
    Shop(
      ...
      description: 'Authentic Indian home-style cooking with traditional recipes',
      ...
      isVerified: true,
      isActive: true,
      featuredProductIds: ['food_004', 'food_005', 'food_006'],
      contact: ShopContact(
        email: 'orders@traditionalkitchen.com',
        phone: '+91 87654 32109',
        website: 'https://traditionalkitchen.com',
        address: ShopAddress(
    ...
    Shop(
      ...
      description: 'World-famous pizzas with fresh ingredients and quick delivery',
      ...
      isVerified: true,
      isActive: true,
      featuredProductIds: ['food_007', 'food_008', 'food_009'],
      contact: ShopContact(
    ...
    Shop(
      id: 'fresh-bowl-co',
      name: 'Fresh Bowl Co.',
      description: 'Healthy salads, bowls, and fresh ingredients for a nutritious meal',
      ...
      isVerified: true,
      isActive: true,
      featuredProductIds: ['food_010', 'food_011', 'food_012'],
      contact: ShopContact(
    ...
    Shop(
      id: 'sweet-delights',
      name: 'Sweet Delights',
      description: 'Delicious desserts, cakes, and sweet treats for every occasion',
      ...
      isVerified: true,
      isActive: true,
      featuredProductIds: ['food_013', 'food_014', 'food_015'],
      contact: ShopContact(
        email: 'orders@sweetdelights.com',
        phone: '+91 54321 09876',
        website: 'https://sweetdelights.com',
        address: ShopAddress(
          street: '321 Dessert Lane',
          city: 'Chennai',
          state: 'Tamil Nadu',
          country: 'India',
          zipCode: '600001',
  ...
  static final Map<String, ShopTheme> _shopThemes = {
    ...
    // Themes for additional food shops
    'gourmet-kitchen': ShopTheme.simple(
      primaryColor: '#D32F2F',
      secondaryColor: '#F44336',
      backgroundColor: '#FFEBEE',
      textColor: '#B71C1C',
      deliveryTime: '30-35 mins',
      specialOffer: 'Items at ₹99 on select items',
    ),

    'traditional-kitchen': ShopTheme.simple(
      primaryColor: '#2E7D32',
      secondaryColor: '#4CAF50',
      backgroundColor: '#E8F5E8',
      textColor: '#1B5E20',
      deliveryTime: '25-30 mins',
      specialOffer: 'Authentic home-style cooking',
    ),

    'pizza-hut': ShopTheme.simple(
      primaryColor: '#D84315',
      secondaryColor: '#FF5722',
      backgroundColor: '#FFF3E0',
      textColor: '#BF360C',
      deliveryTime: '20-25 mins',
      specialOffer: 'Buy 1 Get 1 on selected pizzas',
    ),

    'fresh-bowl-co': ShopTheme.simple(
      primaryColor: '#388E3C',
      secondaryColor: '#66BB6A',
      backgroundColor: '#E8F5E8',
      textColor: '#2E7D32',
      deliveryTime: '15-20 mins',
      specialOffer: 'Fresh & healthy options',
    ),

    'sweet-delights': ShopTheme.simple(
      primaryColor: '#AD1457',
      secondaryColor: '#E91E63',
      backgroundColor: '#FCE4EC',
      textColor: '#880E4F',
      deliveryTime: '25-30 mins',
      specialOffer: 'Sweet treats for every occasion',
    ),
  };
